...
def analyse(frames):
    ...
    return {
        'avg_frame_latency': sum(frame_transmission_times) / len(frame_transmission_times),
        'max_frame_latency': max(frame_transmission_times),
        'avg_packet_latency': sum(packet_transmission_times) / len(packet_transmission_times),
