...
ABSL_FLAG(int, rtt, 1024, "The RTT of the link, in ms.");
ABSL_FLAG(int, buffer_size, 1024, "The buffer size of the routers, in ms.");
ABSL_FLAG(int, duration, 30, "The duration the experiment, in s.");
